...
# Источники
SRCS_AS := boot/boot.asm base/int/isr_stubs.asm base/int/isr32.asm base/int/lidt_load.asm base/int/isr33.asm base/int/isr46.asm base/int/isr47.asm base/int/isr13.asm base/int/isr14.asm
SRCS_C  := main.c base/int/idt.c base/mb2/mb2.c base/mem/mem.c base/sched/sched.c base/sched/tss.c base/time/timer.c base/time/clock.c base/time/rtc.c drv/pic/pic.c drv/io/io.c libc/string.c libc/stckprt.c drv/fb/fb.c base/term/term.c drv/pci/pci.c base/rsod/rsod.c drv/sound/pcs/pcs.c drv/kbd/kbd.c drv/acpi/acpi.c drv/disk/ide.c base/term/cmd.c drv/block/blockdev.c drv/usb/usbdev/usbdev.c drv/usb/ehci/ehci.c drv/acpi/aml.c base/mem/pmm.c base/mem/paging.c base/exp/exp.c base/term/tio.c drv/disk/ahci.c  fs/vfs/vfs.c fs/exfat/exfat.c base/elfload/elfload.c fs/devfs/devfs.c fs/devfs/std.c fs/devfs/blk.c
# Объекты
