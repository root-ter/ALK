...
# Источники
SRCS_AS := boot/boot.asm base/int/isr_stubs.asm base/int/isr32.asm base/int/lidt_load.asm base/int/isr33.asm base/int/isr46.asm base/int/isr47.asm base/int/isr_ahci.asm
SRCS_C  := main.c base/int/idt.c base/mb2/mb2.c base/mem/mem.c base/sched/sched.c base/sched/tss.c base/time/timer.c base/time/clock.c base/time/rtc.c drv/pic/pic.c drv/io/io.c libc/string.c libc/stckprt.c drv/fb/fb.c base/term/term.c drv/pci/pci.c base/rsod/rsod.c drv/sound/pcs/pcs.c drv/kbd/kbd.c drv/acpi/acpi.c drv/disk/ide.c base/term/cmd.c drv/block/blockdev.c drv/usb/ehci.c drv/acpi/aml.c drv/disk/ahci.c
# Объекты
